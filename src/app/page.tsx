...
import { Sparkles, Cable, ClipboardCheck, PowerOff, Megaphone } from 'lucide-react';
      ...
      >
        <Card className="shadow-xl border-none bg-card p-6 rounded-lg relative z-[1]">
          <CardHeader className="border-b border-border/30 pb-4 mb-6">
            <CardTitle className="text-3xl font-bold tracking-tight text-primary mb-1">E418 教室使用規則</CardTitle>
            <CardDescription className="pt-1 text-muted-foreground/80">請各位使用者共同維護教室環境與設備。</CardDescription>
          </CardHeader>
          <CardContent className="px-2">
            <ul className="space-y-4">
              <li className="flex items-start">
                <Sparkles className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-sky-500 dark:text-sky-400" />
                <span className="text-base leading-relaxed text-foreground">請保持教室整潔，離開時將個人物品帶走。</span>
              </li>
              <li className="flex items-start">
                <Cable className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-orange-500 dark:text-orange-400" />
                <span className="text-base leading-relaxed text-foreground">請勿隨意更動教室設備線路與設定。</span>
              </li>
              <li className="flex items-start">
                <ClipboardCheck className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-green-500 dark:text-green-400" />
                <span className="text-base leading-relaxed text-foreground">若需使用特殊軟體或設備，請提前申請。</span>
              </li>
              <li className="flex items-start">
                <PowerOff className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-red-500 dark:text-red-400" />
                <span className="text-base leading-relaxed text-foreground">實驗完成後，請確實關閉儀器電源。</span>
              </li>
              <li className="flex items-start">
                <Megaphone className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-purple-500 dark:text-purple-400" />
                <span className="text-base leading-relaxed text-foreground">如遇任何問題，請聯繫管理人員。</span>
              </li>
            </ul>
          </CardContent>
        </Card>
